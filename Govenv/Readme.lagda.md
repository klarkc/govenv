...
readme = record
  ...
  ; currentSummary = "`Verdict`, typed `Fact`, dependency-indexed `Rule`, typed roadmap structure, materialization closure, and roadmap integrity are in place; typed release governance is the next active governance work."
