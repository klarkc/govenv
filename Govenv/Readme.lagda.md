...
readme = record
  ...
  ; currentSummary = "`Verdict`, typed `Fact`, and dependency-indexed `Rule` are in place; the roadmap release rule and Govenv's first self-governing repository rule are next."
