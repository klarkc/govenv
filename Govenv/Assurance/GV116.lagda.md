...
derived from that history, and a validated one-time genesis boundary for legacy
cutover. It does **not** mark GV116 complete; Govenv's real revision-bound genesis,
the live roadmap, snapshots, and release deltas still remain to migrate onto the
