...
append-only constitutional-history kernel plus lifecycle and supersession lineage
derived from that history. It does **not** mark GV116 complete; the live roadmap,
snapshots, and release deltas still consume the legacy model until later migration
stages replace those authorities.
